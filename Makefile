all : post sign_in sign_up home db_test get_all_friend_team get_friends_by_team query_users get_notification send_friend_request get_notification_num add_new_team confirm_friend_request
