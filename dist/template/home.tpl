            ...
            <div class="container-fluid">
		  	...
		  	<option value="reject">拒绝</option>
                ...
                <div class="input-group col-md-8 col-md-offset-2">
                  ...
                  <br>
                  <div id="add_new_team" style="display:none;" class="input-group col-md-8 col-md-offset-2">   
                    <span class="input-group-addon">组名</span>
                    <input type="text" class="form-control" id="input_team_name"> 
                  </div>
		 <br>
                  <button class="btn btn-primary col-md-offset-2" id="button_add_new_team">创建分组</button>
                  </div>
              </div>
            </div>
          </div>
